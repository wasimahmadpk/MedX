...
ARTICLES = [
    ...
    # Lunch-break reads — short (≤4 min), light complexity (≤0.3)
    {"id": "a33", "title": "Chest Pain Triage: 5 Red Flags in 3 Minutes",
     "tags": ["cardiology", "chest pain", "triage", "quick_read", "emergency"],
     "specialty": "cardiology", "type": "education",
     "summary": "A fast checklist for distinguishing urgent cardiac chest pain in primary and acute care.",
     "complexity_score": 0.25, "reading_time_minutes": 3},
    {"id": "a34", "title": "Home Blood Pressure: Quick Instructions for Patients",
     "tags": ["cardiology", "hypertension", "patient_education", "quick_read"],
     "specialty": "cardiology", "type": "education",
     "summary": "Simple cuff placement, timing, and logging tips you can share with patients in under four minutes.",
     "complexity_score": 0.2, "reading_time_minutes": 3},
    {"id": "a35", "title": "Vertigo: Peripheral vs Central — Lunch-Break Checklist",
     "tags": ["neurology", "vertigo", "diagnosis", "quick_read"],
     "specialty": "neurology", "type": "education",
     "summary": "HINTS-style red flags and bedside clues to spot central causes before referral.",
     "complexity_score": 0.28, "reading_time_minutes": 4},
    {"id": "a36", "title": "MRI or CT? Imaging Choices in 4 Minutes",
     "tags": ["radiology", "imaging", "decision_support", "quick_read"],
     "specialty": "radiology", "type": "education",
     "summary": "When to choose MRI versus CT for common outpatient presentations — no deep protocol detail.",
     "complexity_score": 0.25, "reading_time_minutes": 4},
    {"id": "a37", "title": "Sun Protection Counselling: A 3-Minute Skin Cancer Talk",
     "tags": ["dermatology", "oncology", "prevention", "quick_read", "patient_education"],
     "specialty": "dermatology", "type": "education",
     "summary": "Evidence-based SPF, exposure, and self-exam advice for a brief preventive visit.",
     "complexity_score": 0.2, "reading_time_minutes": 3},
    {"id": "a38", "title": "Childhood Fever: Reassure or Refer — Quick Guide",
     "tags": ["pediatrics", "fever", "triage", "quick_read"],
     "specialty": "pediatrics", "type": "clinical_guidance",
     "summary": "Age-based red flags and safe home-care advice for busy same-day paediatric slots.",
     "complexity_score": 0.25, "reading_time_minutes": 4},
    {"id": "a39", "title": "FIT Screening: Explain It to Patients in 3 Minutes",
     "tags": ["oncology", "colorectal", "screening", "quick_read", "patient_education"],
     "specialty": "oncology", "type": "education",
     "summary": "Plain-language script for stool-based colorectal screening during a short consultation.",
     "complexity_score": 0.22, "reading_time_minutes": 3},
    {"id": "a40", "title": "Micro-Break Mindfulness for Clinicians",
     "tags": ["psychiatry", "wellbeing", "physician_health", "quick_read"],
     "specialty": "psychiatry", "type": "education",
     "summary": "Two evidence-backed breathing techniques for a five-minute reset between patients.",
     "complexity_score": 0.15, "reading_time_minutes": 3},
]
...
INTERACTIONS = [
    ...
    # Lunch-break quick reads (popular at midday across specialties)
    ("d1",  "a33", 5), ("d4",  "a34", 4), ("d11", "a33", 4), ("d11", "a34", 5),
    ("d2",  "a35", 5), ("d6",  "a35", 4), ("d12", "a36", 5), ("d12", "a36", 4),
    ("d9",  "a37", 5), ("d15", "a37", 4), ("d5",  "a38", 5), ("d13", "a38", 4),
